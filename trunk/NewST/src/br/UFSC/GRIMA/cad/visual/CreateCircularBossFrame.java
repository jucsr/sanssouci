/*
 * Created by JFormDesigner on Wed Mar 21 17:13:42 BRT 2012
 */
 ...
 * @author Lucas
 */
public class CreateCircularBossFrame extends JDialog {
	public CreateCircularBossFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public CreateCircularBossFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
