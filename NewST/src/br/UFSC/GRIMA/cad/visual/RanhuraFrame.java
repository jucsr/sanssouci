...
public class RanhuraFrame extends JDialog {
	public RanhuraFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public RanhuraFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
				...
				//======== contentPanel ========
				{
					...
					//======== panel3 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner1.setBounds(165, 95, 40, spinner1.getPreferredSize().height);

							//---- spinner2 ----
							spinner2.setModel(new SpinnerNumberModel(7.0, 0.0, null, 1.0));
							layeredPane1.add(spinner2, JLayeredPane.DEFAULT_LAYER);
							spinner2.setBounds(130, 305, 40, spinner2.getPreferredSize().height);

							//---- spinner3 ----
							spinner3.setModel(new SpinnerNumberModel(10.0, 0.0, null, 1.0));
							layeredPane1.add(spinner3, JLayeredPane.DEFAULT_LAYER);
							spinner3.setBounds(130, 165, 40, spinner3.getPreferredSize().height);

							//---- spinner4 ----
							spinner4.setModel(new SpinnerNumberModel(0.0, 0.0, null, 1.0));
							layeredPane1.add(spinner4, JLayeredPane.DEFAULT_LAYER);
							spinner4.setBounds(10, 275, 35, spinner4.getPreferredSize().height);

							//---- labelImage ----
							labelImage.setIcon(new ImageIcon(getClass().getResource("/images/RanhuraSimples.png")));
