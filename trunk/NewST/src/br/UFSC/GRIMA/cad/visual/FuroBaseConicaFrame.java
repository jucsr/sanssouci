/*
 * Created by JFormDesigner on Tue Nov 16 19:27:43 BRST 2010
 */
 ...
 * @author Victor
 */
public class FuroBaseConicaFrame extends JDialog {
	public FuroBaseConicaFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public FuroBaseConicaFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Criar Furo com base c\u00f4nica");
		...
		//======== scrollPane2 ========
		{
			...
			//======== dialogPane ========
			{
				...
				//======== contentPanel ========
				{
					...
					//======== panel9 ========
					{
						panel9.setBorder(new TitledBorder("Dimens\u00f5es em mil\u00edmetros (\u00e1ngulo em graus sexagesimais)"));
						panel9.setLayout(new GridBagLayout());
						((GridBagLayout)panel9.getLayout()).columnWidths = new int[] {0, 372, 0, 0};
						...
						//======== layeredPane1 ========
						{
							...
							spinner4.setBounds(110, 165, 40, spinner4.getPreferredSize().height);

							//---- spinner2 ----
							spinner2.setModel(new SpinnerNumberModel(7.5, 0.0, null, 1.0));
							layeredPane1.add(spinner2, JLayeredPane.DEFAULT_LAYER);
							spinner2.setBounds(110, 75, 40, spinner2.getPreferredSize().height);

							//---- spinner5 ----
							spinner5.setModel(new SpinnerNumberModel(30.0, 0.0, null, 1.0));
							layeredPane1.add(spinner5, JLayeredPane.DEFAULT_LAYER);
							spinner5.setBounds(255, 155, 40, spinner5.getPreferredSize().height);

							//---- angulo ----
							angulo.setModel(new SpinnerNumberModel(20.0, 0.0, 70.0, 1.0));
							angulo.setToolTipText("coloque o \u00e1ngulo da base c\u00f4nica");
							layeredPane1.add(angulo, JLayeredPane.DEFAULT_LAYER);
							angulo.setBounds(115, 355, 40, angulo.getPreferredSize().height);
							...
							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/FuroBaseConica.png")));
					...
					//======== panel10 ========
					{
						...
						//======== panel8 ========
						{
							...
							//---- textField9 ----
							textField9.setText("Furo com base conica");
						...
						//======== panel5 ========
						{
							...
							((GridBagLayout)panel5.getLayout()).columnWidths = new int[] {0, 0, 45, 0, 0, 0};
							...
							//---- labelDepth ----
							labelDepth.setText("toler\u00e2ncia do di\u00e2metro");
							...
							//---- label11 ----
							label11.setText("textura das superficies");
