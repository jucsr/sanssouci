/*
 * Created by JFormDesigner on Tue Nov 09 14:39:08 BRST 2010
 */
 ...
 * @author Victor
 */
public class FuroFrame extends JDialog {
	public FuroFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public FuroFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Criar Furo com base plana");
				...
				//======== contentPanel ========
				{
					...
					//======== panel9 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner1.setBounds(240, 310, 40, spinner1.getPreferredSize().height);

							//---- spinner3 ----
							spinner3.setModel(new SpinnerNumberModel(7.5, 0.0, null, 1.0));
							layeredPane1.add(spinner3, JLayeredPane.DEFAULT_LAYER);
							spinner3.setBounds(105, 75, 40, spinner3.getPreferredSize().height);

							//---- spinner2 ----
							spinner2.setModel(new SpinnerNumberModel(30.0, 0.0, null, 1.0));
							layeredPane1.add(spinner2, JLayeredPane.DEFAULT_LAYER);
							spinner2.setBounds(120, 155, 40, spinner2.getPreferredSize().height);

							//---- spinner4 ----
							spinner4.setModel(new SpinnerNumberModel(30.0, 0.0, null, 1.0));
							layeredPane1.add(spinner4, JLayeredPane.DEFAULT_LAYER);
							spinner4.setBounds(255, 155, 40, spinner4.getPreferredSize().height);

							//---- spinner6 ----
							spinner6.setModel(new SpinnerNumberModel(0.0, 0.0, null, 1.0));
							layeredPane1.add(spinner6, JLayeredPane.DEFAULT_LAYER);
							spinner6.setBounds(10, 270, 35, spinner6.getPreferredSize().height);

							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/FuroBasePlana.png")));
					...
					//======== panel10 ========
					{
						...
						//======== panel8 ========
						{
							...
							//---- textField9 ----
							textField9.setText("Furo com base plana");
						...
						//======== panel5 ========
						{
							...
							((GridBagLayout)panel5.getLayout()).columnWidths = new int[] {0, 0, 45, 0, 45, 0, 40, 0};
							...
							//---- label8 ----
							label8.setText("toler\u00e2ncia do di\u00e2metro");
							...
							//---- spinner5 ----
							spinner5.setModel(new SpinnerNumberModel(50.0, 0.0, 50.0, 1.0));
							...
							panel5.add(label9, new GridBagConstraints(3, 0, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
							...
							panel5.add(label10, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));

							//---- label2 ----
							label2.setText("Passante");
						...
						panel10.add(panel5, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
