/*
 * Created by JFormDesigner on Fri May 20 16:14:36 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewBallEndMillFrame extends JDialog {
	public AddNewBallEndMillFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewBallEndMillFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Add new Ball End Mill");
				...
				//======== panel2 ========
				{
					...
					//======== panel1 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner1.setBounds(50, 155, 41, spinner1.getPreferredSize().height);

							//---- spinner2 ----
							spinner2.setModel(new SpinnerNumberModel(60.0, 0.0, null, 1.0));
							layeredPane1.add(spinner2, JLayeredPane.DEFAULT_LAYER);
							spinner2.setBounds(200, 235, 36, spinner2.getPreferredSize().height);
							...
							spinner5.setBounds(149, 0, 40, 21);

							//---- spinner3 ----
							spinner3.setModel(new SpinnerNumberModel(70.0, 0.0, null, 1.0));
							layeredPane1.add(spinner3, JLayeredPane.DEFAULT_LAYER);
							spinner3.setBounds(85, 225, 41, spinner3.getPreferredSize().height);

							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/ballEndMill.png")));
