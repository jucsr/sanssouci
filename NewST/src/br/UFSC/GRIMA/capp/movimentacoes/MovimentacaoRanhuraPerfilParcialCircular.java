		...
		if(this.ranhuraParcCirc.getEixo()== RanhuraPerfilCircularParcial.VERTICAL){
			...
			for(i=(int)numeroDeAps;i>0;i--){
				if(largura<diametroFerramenta)
					...
					for(k=(int)numeroDeAes;k>0;k--){//COME�A A FAZER A MOVIMENTA�AO DE UM AP
						if(k==1 && ultimoAe==0){//SE O ULTIMOAE FOR ZERO ELE SAI DO LA�O
							if(fundo)
										...
										if(alfa>90*Math.PI/180){//ranhura deitada para ESQUERDA
											if(!fundo){//MOVIMENTO DA ESQUERDA PRA DIREITA
												...
												if(xAtual==0){
													...
													yAtual+=(xAtual-ae)/Math.abs(Math.tan(alfa));//xAtual-ae � um numero negativo, por isso soma
												}
											}
										}
											...
											if(!fundo){//MOVIMENTO DA ESQUERDA PARA DIREITA ---->
												if(xAtual==this.face.getComprimento())
													yAtual-=Math.tan(alfa)*ae;//O XATUAL EST� BUGANDO O cima....
										...
										if(alfa>90*Math.PI/180){//ranhura deitada para ESQUERDA
											if(!fundo){//MOVIMENTO DA ESQUERDA PRA DIREITA
												...
												if(xAtual==0){
													...
													yAtual+=(xAtual-ultimoAe)/Math.abs(Math.tan(alfa));//xAtual-ae � um numero negativo, por isso soma
												}
												fundo=true;
											}
										}
											...
											if(!fundo){//MOVIMENTO DA ESQUERDA PARA DIREITA ---->
												if(xAtual==this.face.getComprimento())
													yAtual-=Math.tan(alfa)*ultimoAe;//O XATUAL EST� BUGANDO O cima....
												else if(xAtual+ae>this.face.getComprimento()){
													hold2=xAtual;
													xAtual=this.face.getComprimento();
													yAtual=this.face.getLargura();
										...
										if(alfa>90*Math.PI/180){//ranhura deitada para ESQUERDA
											if(!fundo){//MOVIMENTO DA ESQUERDA PRA DIREITA
												...
												if(yAtual==0){
													...
													xAtual+=(yAtual-ae)/Math.abs(Math.tan(alfa));//xAtual-ae � um numero negativo, por isso soma
												}
											}
										}
										else if(alfa<90*Math.PI/180){//ranhura deitada para direita
											if(!fundo){//MOVIMENTO DA ESQUERDA PARA DIREITA ---->
												if(yAtual==this.face.getLargura())
													xAtual-=Math.tan(alfa)*ae;//O XATUAL EST� BUGANDO O cima....
										...
										if(alfa>90*Math.PI/180){//ranhura deitada para ESQUERDA
											if(!fundo){//MOVIMENTO DA ESQUERDA PRA DIREITA
												...
												if(yAtual==0){
													...
													xAtual+=(yAtual-ultimoAe)/Math.abs(Math.tan(alfa));//xAtual-ae � um numero negativo, por isso soma
												}
												fundo=true;
											}
										}
											...
											if(!fundo){//MOVIMENTO DA ESQUERDA PARA DIREITA ---->
												if(yAtual==this.face.getLargura())
													xAtual-=Math.tan(alfa)*ultimoAe;//O XATUAL EST� BUGANDO O cima....
												else if(yAtual+ae>this.face.getLargura()){
													hold2=yAtual;
													xAtual=this.face.getComprimento();
													yAtual=this.face.getLargura();
