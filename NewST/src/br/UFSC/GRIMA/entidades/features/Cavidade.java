...
//		}
	...
	public static Point2D[] determinarPontosEmRoundRectangular(Point3d position, double comprimento, double largura, double raio, int numeroDePontos) // o position � a coodenada da origem do roundRectangular
	{
