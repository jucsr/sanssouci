...
public class FuroBaseArredondadaFrame extends JDialog {
	public FuroBaseArredondadaFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public FuroBaseArredondadaFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Criar Furo com base arredondada");
				...
				//======== contentPanel ========
				{
					...
					//======== panel9 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner1.setBounds(265, 305, 40, spinner1.getPreferredSize().height);
							...
							//---- r1 ----
							r1.setModel(new SpinnerNumberModel(2.0, 1.0, 70.0, 1.0));
							r1.setToolTipText("coloque o \u00e1ngulo da base c\u00f4nica");
							layeredPane1.add(r1, JLayeredPane.DEFAULT_LAYER);
							r1.setBounds(110, 350, 40, r1.getPreferredSize().height);
							...
							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/FuroBaseArredondada.png")));
					...
					//======== panel10 ========
					{
						...
						//======== panel8 ========
						{
							...
							//---- textField9 ----
							textField9.setText("Furo com base arredondada");
