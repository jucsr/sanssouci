/*
 * Created by JFormDesigner on Fri May 20 16:15:09 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewReamerFrame extends JDialog {
	public AddNewReamerFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewReamerFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
					...
					//======== panel3 ========
					{
						...
						//======== panel4 ========
						{
							...
							//======== panel6 ========
							{
								...
								//---- spinner8 ----
								spinner8.setModel(new SpinnerNumberModel(8, 1, 20, 1));
