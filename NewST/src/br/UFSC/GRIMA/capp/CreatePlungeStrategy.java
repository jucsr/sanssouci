...
//							}
						...
						else /**se nao esta no ultimo caminho*/
						{
							...
							else //nao eh zero nem o penultimo
							{
								if (flag==true)//indo
									aux ++; //eh o contador pra saber quantos caminhos a ferramenta andou
								else
