/*
 * Created by JFormDesigner on Fri May 20 16:14:52 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewBoringToolFrame extends JDialog {
	public AddNewBoringToolFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewBoringToolFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
				...
				//======== panel2 ========
				{
					...
					//======== panel1 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner1.setBounds(130, 175, 41, spinner1.getPreferredSize().height);

							//---- spinner2 ----
							spinner2.setModel(new SpinnerNumberModel(60.0, 0.0, null, 1.0));
							layeredPane1.add(spinner2, JLayeredPane.DEFAULT_LAYER);
							spinner2.setBounds(165, 46, 41, spinner2.getPreferredSize().height);
