			...
			try {
				...
				if (posicaoX > 0 /*&& x < Maquina.posicaoXCv*/) {
					...
					JOptionPane.showMessageDialog(null,
							"Digite um N�mero positivo para a posi��o X da cavidade",
							"Erro na posi��o X", JOptionPane.OK_CANCEL_OPTION);
				}
			} catch (Exception e) {
				JOptionPane.showMessageDialog(null,
						"Digite um N�mero positivo para a posi��o X da cavidade"
...
//							"Erro no raio de concordancia", JOptionPane.OK_CANCEL_OPTION);
		...
		if (ok)
		{
			...
			{
				JOptionPane.showMessageDialog(null, "Erro na cria��o da Cavidade", "Feature invalida", JOptionPane.OK_CANCEL_OPTION);
			}
		}
	}
	private void cancel()
