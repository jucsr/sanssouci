/*
 * Created by JFormDesigner on Fri May 20 16:15:03 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewFaceMillFrame extends JDialog {
	public AddNewFaceMillFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewFaceMillFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
