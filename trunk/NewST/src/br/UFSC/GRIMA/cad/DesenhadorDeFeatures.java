...
//				
			...
			case 2:  //face ZY
				if (this.dFeaturesSecundarias)
				{
					...
					p2X = (int)Math.round((faceDesenhada.getComprimentoDesenhado(verticeAtivado) - (-cavidade.getPosicaoZ() -cb.getPosicaoZ() + (cavidade.getProfundidade() - cb.getAltura()) )  + 5) * zoom + origem.x);
