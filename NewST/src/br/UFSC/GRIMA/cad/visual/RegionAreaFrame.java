/*
 * Created by JFormDesigner on Wed Oct 17 19:38:58 BRT 2012
 */
 ...
 * @author Brainrain
 */
public class RegionAreaFrame extends JDialog {
	public RegionAreaFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public RegionAreaFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Define the Region Area");
			...
			//======== contentPanel ========
			{
				...
				//======== panel3 ========
				{
					...
					//======== panel1 ========
					{
						...
						//======== toolBar3 ========
						{
							...
							//======== panel2 ========
							{
								...
								((GridBagLayout)panel2.getLayout()).columnWidths = new int[] {0, 0, 0, 0, 0, 0, 0, 40, 0};
					...
					//======== panel4 ========
					{
						...
						//---- textField1 ----
						textField1.setText("BEZIER REGION");
