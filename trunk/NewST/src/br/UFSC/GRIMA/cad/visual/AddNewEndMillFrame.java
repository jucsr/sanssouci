/*
 * Created by JFormDesigner on Tue Jun 07 13:35:56 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewEndMillFrame extends JDialog {
	public AddNewEndMillFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewEndMillFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
				...
				//======== panel2 ========
				{
					...
					//======== panel1 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner4.setBounds(134, 321, 36, spinner4.getPreferredSize().height);
							...
							spinner3.setBounds(80, 235, 36, spinner3.getPreferredSize().height);

							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/endMill.png")));
