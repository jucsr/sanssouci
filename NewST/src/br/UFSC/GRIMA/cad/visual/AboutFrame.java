...
public class AboutFrame extends JDialog {
	...
	public AboutFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
		...
		//======== dialogPane ========
		{
			...
			//======== contentPanel ========
			{
				...
				//======== panel1 ========
				{
					...
					((GridBagLayout)panel1.getLayout()).columnWidths = new int[] {300, 0};
					((GridBagLayout)panel1.getLayout()).rowHeights = new int[] {200, 0};
					...
					//======== layeredPane1 ========
					{
						...
						editorPane1.setText("GRIMA");
						editorPane1.setFont(new Font("Berlin Sans FB", Font.PLAIN, 13));
						editorPane1.setSelectionColor(new Color(153, 153, 153));
						layeredPane1.add(editorPane1, JLayeredPane.DEFAULT_LAYER);
						editorPane1.setBounds(20, 90, 265, 110);

						//---- label1 ----
						label1.setIcon(new ImageIcon(getClass().getResource("/images/logo programa.png")));
