/*
 * Created by JFormDesigner on Fri May 20 16:15:14 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewToolFrame extends JDialog {
	public AddNewToolFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewToolFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== dialogPane ========
		{
			...
			dialogPane.setToolTipText("click on the letters in the picture and set the tool parameters");
				...
				//======== panel2 ========
				{
					...
					//======== panel1 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner2.setBounds(195, 200, 40, spinner2.getPreferredSize().height);

							//---- spinner3 ----
							spinner3.setModel(new SpinnerNumberModel(40.0, 0.0, null, 1.0));
							layeredPane1.add(spinner3, JLayeredPane.DEFAULT_LAYER);
							spinner3.setBounds(150, 235, 40, spinner3.getPreferredSize().height);

							//---- spinner4 ----
							spinner4.setModel(new SpinnerNumberModel(20.0, 1.0, null, 1.0));
							layeredPane1.add(spinner4, JLayeredPane.DEFAULT_LAYER);
							spinner4.setBounds(105, 280, 40, spinner4.getPreferredSize().height);

							//---- spinner5 ----
							spinner5.setModel(new SpinnerNumberModel(20.0, 0.0, null, 1.0));
							layeredPane1.add(spinner5, JLayeredPane.DEFAULT_LAYER);
							spinner5.setBounds(105, 45, 40, spinner5.getPreferredSize().height);

							//---- spinner6 ----
							spinner6.setModel(new SpinnerNumberModel(30.0, 0.0, null, 1.0));
							layeredPane1.add(spinner6, JLayeredPane.DEFAULT_LAYER);
							spinner6.setBounds(155, 160, 40, 21);

							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/faceMill.png")));
							layeredPane1.add(label1, JLayeredPane.DEFAULT_LAYER);
							label1.setBounds(0, 0, label1.getPreferredSize().width, 344);
						}
					...
					//======== panel3 ========
					{
						...
						//======== panel4 ========
						{
							...
							panel4.add(comboBox2, new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 0), 0, 0));

							//---- label3 ----
							label3.setText("Material");
							panel4.add(label3, new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
							...
							panel4.add(comboBox1, new GridBagConstraints(2, 3, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 0), 0, 0));

							//---- label4 ----
							label4.setText("N. Teeth");
							panel4.add(label4, new GridBagConstraints(1, 4, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
							...
							panel4.add(panel6, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 0), 0, 0));

							//---- label6 ----
							label6.setText("Sense");
							panel4.add(label6, new GridBagConstraints(1, 5, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
							...
							panel4.add(comboBox3, new GridBagConstraints(2, 5, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 0), 0, 0));

							//---- label7 ----
							label7.setText("Internal Cooling");
							panel4.add(label7, new GridBagConstraints(1, 6, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 0, 5), 0, 0));
							panel4.add(checkBox1, new GridBagConstraints(2, 6, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 0, 0), 0, 0));
						}
