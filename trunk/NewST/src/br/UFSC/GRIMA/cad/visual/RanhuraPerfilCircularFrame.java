/*
 * Created by JFormDesigner on Sun Nov 21 18:58:08 BRST 2010
 */
 ...
 * @author Victor
 */
public class RanhuraPerfilCircularFrame extends JDialog {
	public RanhuraPerfilCircularFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public RanhuraPerfilCircularFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Criar Ranhura com perfil circular");
				...
				//======== contentPanel ========
				{
					...
					//======== panel3 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner4.setBounds(135, 150, 40, spinner4.getPreferredSize().height);
							...
							//---- labelImage ----
							labelImage.setIcon(new ImageIcon(getClass().getResource("/images/RanhuraPerfilCircularHorizontal.png")));
					...
					//======== panel2 ========
					{
						...
						//======== panel4 ========
						{
							...
							//======== layeredPane2 ========
							{
								...
								spinner1.setBounds(185, 25, 40, spinner1.getPreferredSize().height);

								//---- spinner2 ----
								spinner2.setModel(new SpinnerNumberModel(5.0, 0.0, null, 1.0));
								layeredPane2.add(spinner2, JLayeredPane.DEFAULT_LAYER);
								spinner2.setBounds(85, 25, 40, spinner2.getPreferredSize().height);

								//---- label4 ----
								label4.setIcon(new ImageIcon(getClass().getResource("/images/perfilParcialCircular.png")));
						...
						//======== panel1 ========
						{
							...
							//---- textFieldNome ----
							textFieldNome.setText("ranhura com perfil circular");
						...
						//======== panel7 ========
						{
							...
							((GridBagLayout)panel7.getLayout()).columnWidths = new int[] {0, 45, 0, 50, 0};
							...
							panel7.add(label8, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));

							//---- ranhuraRug ----
							ranhuraRug.setModel(new SpinnerNumberModel(50.0, 0.0, 50.0, 1.0));
							panel7.add(ranhuraRug, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
