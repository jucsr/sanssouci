...
public class FuroBaseEsfericaFrame extends JDialog {
	public FuroBaseEsfericaFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public FuroBaseEsfericaFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Criar Furo com base esf\u00e9rica");
				...
				//======== contentPanel ========
				{
					...
					//======== panel9 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner1.setBounds(235, 305, 40, spinner1.getPreferredSize().height);

							//---- spinner4 ----
							spinner4.setModel(new SpinnerNumberModel(30.0, 0.0, null, 1.0));
							layeredPane1.add(spinner4, JLayeredPane.DEFAULT_LAYER);
							spinner4.setBounds(115, 155, 40, spinner4.getPreferredSize().height);
							...
							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/FuroBaseEsferica.png")));
					...
					//======== panel10 ========
					{
						...
						//======== panel8 ========
						{
							...
							//---- textField9 ----
							textField9.setText("Furo com base esf\u00e9rica");
						...
						//======== panel5 ========
						{
							...
							panel5.add(label4, new GridBagConstraints(3, 1, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
						}
