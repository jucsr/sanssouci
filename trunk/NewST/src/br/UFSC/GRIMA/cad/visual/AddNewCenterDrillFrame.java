/*
 * Created by JFormDesigner on Mon Jun 06 16:32:49 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewCenterDrillFrame extends JDialog {
	public AddNewCenterDrillFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewCenterDrillFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
				...
				//======== panel2 ========
				{
					...
					//======== panel1 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner5.setBounds(300, 153, 40, spinner5.getPreferredSize().height);
							...
							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/centerDrill.png")));
