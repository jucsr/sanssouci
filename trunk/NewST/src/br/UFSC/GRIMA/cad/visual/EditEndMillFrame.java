/*
 * Created by JFormDesigner on Tue Aug 30 13:55:39 BRT 2011
 */
 ...
 * @author ssiaum
 */
public class EditEndMillFrame extends JDialog {
	public EditEndMillFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public EditEndMillFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
				...
				//======== tabbedPane1 ========
				{
						...
						//======== panel11 ========
						{
							...
							//======== panel12a ========
							{
								...
								//======== layeredPane2 ========
								{
									...
									//---- spinner13 ----
									spinner13.setModel(new SpinnerNumberModel(0.0, 0.0, 10.0, 0.1));
									layeredPane2.add(spinner13, JLayeredPane.DEFAULT_LAYER);
									spinner13.setBounds(260, 230, 44, spinner13.getPreferredSize().height);

									//---- spinner14 ----
									spinner14.setModel(new SpinnerNumberModel(0.0, 0.0, 10.0, 0.1));
									layeredPane2.add(spinner14, JLayeredPane.DEFAULT_LAYER);
									spinner14.setBounds(130, 285, 44, spinner14.getPreferredSize().height);

									//---- spinner15 ----
									spinner15.setModel(new SpinnerNumberModel(10.0, 0.0, null, 1.0));
									layeredPane2.add(spinner15, JLayeredPane.DEFAULT_LAYER);
									spinner15.setBounds(285, 125, 45, spinner15.getPreferredSize().height);
							...
							//======== panel12 ========
							{
								...
								//======== panel13 ========
								{
									...
									panel13.add(label23, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
										GridBagConstraints.CENTER, GridBagConstraints.BOTH,
										new Insets(0, 0, 5, 5), 0, 0));

									//---- label24 ----
									label24.setText("Bottom and Side Finish Milling");
									panel13.add(label24, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
										GridBagConstraints.CENTER, GridBagConstraints.BOTH,
										new Insets(0, 0, 5, 0), 0, 0));

									//---- label17 ----
									label17.setText("Id:");
									panel13.add(label17, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
										GridBagConstraints.CENTER, GridBagConstraints.BOTH,
										new Insets(0, 0, 5, 5), 0, 0));

									//---- formattedTextField3 ----
									formattedTextField3.setFont(new Font("Berlin Sans FB", Font.PLAIN, 13));
									panel13.add(formattedTextField3, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
										GridBagConstraints.CENTER, GridBagConstraints.BOTH,
										new Insets(0, 0, 5, 0), 0, 0));

									//---- label18 ----
									label18.setText("Coolant:");
									panel13.add(label18, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
										GridBagConstraints.CENTER, GridBagConstraints.BOTH,
										new Insets(0, 0, 0, 5), 0, 0));
									...
									panel13.add(checkBox3, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
										GridBagConstraints.CENTER, GridBagConstraints.BOTH,
										new Insets(0, 0, 0, 0), 0, 0));
								}
						...
						//======== panel5 ========
						{
							...
							//======== panel6 ========
							{
								...
								//======== layeredPane1 ========
								{
									...
									spinner1.setBounds(230, 150, 40, spinner1.getPreferredSize().height);

									//---- spinner2 ----
									spinner2.setModel(new SpinnerNumberModel(50.0, 0.0, null, 1.0));
									layeredPane1.add(spinner2, JLayeredPane.DEFAULT_LAYER);
									spinner2.setBounds(190, 245, 36, spinner2.getPreferredSize().height);

									//---- spinner4 ----
									spinner4.setModel(new SpinnerNumberModel(20.0, 1.0, null, 1.0));
									layeredPane1.add(spinner4, JLayeredPane.DEFAULT_LAYER);
									spinner4.setBounds(130, 320, 41, spinner4.getPreferredSize().height);

									//---- spinner5 ----
									spinner5.setModel(new SpinnerNumberModel(20.0, 0.0, null, 1.0));
									layeredPane1.add(spinner5, JLayeredPane.DEFAULT_LAYER);
									spinner5.setBounds(130, 0, 41, spinner5.getPreferredSize().height);

									//---- spinner3 ----
									spinner3.setModel(new SpinnerNumberModel(50.0, 0.0, null, 1.0));
									layeredPane1.add(spinner3, JLayeredPane.DEFAULT_LAYER);
									spinner3.setBounds(75, 240, 38, spinner3.getPreferredSize().height);

									//---- label6 ----
									label6.setIcon(new ImageIcon(getClass().getResource("/images/endMill.png")));
							...
							//======== panel7 ========
							{
								...
								//======== panel8 ========
								{
									...
									//======== panel9 ========
									{
										...
										//---- spinner8 ----
										spinner8.setModel(new SpinnerNumberModel(6, 1, 20, 1));
					...
					//======== panel3 ========
					{
						...
						//======== layeredPane3 ========
						{
							...
							spinner11.setBounds(350, 190, 46, spinner11.getPreferredSize().height);
							...
							//---- label25 ----
							label25.setIcon(new ImageIcon(getClass().getResource("/images/technologyMill.png")));
