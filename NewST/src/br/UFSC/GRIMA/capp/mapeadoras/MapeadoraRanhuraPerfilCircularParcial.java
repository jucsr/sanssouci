...
public class MapeadoraRanhuraPerfilCircularParcial {

	private Projeto projeto;
	private Bloco bloco;
	private Face faceTmp;
	private RanhuraPerfilCircularParcial ranhuraTmp;
	...
	public MapeadoraRanhuraPerfilCircularParcial(Projeto projeto, Face face, RanhuraPerfilCircularParcial ranhura) {
	...
	private void mapearRanhura() {
		...
		if (ranhuraTmp.isAcabamento()) {
			...
			wsTmp.setId("ParcialCircularSlot_RGH");
			...
			wsTmp.setId("ParcialCircularSlot_FNS");
			wsTmp.setWorkingstepPrecedente(wsPrecedenteTmp);
			wsPrecedenteTmp = wsTmp;
	...
	private FaceMill chooseFaceMill(Material material,
			ArrayList<FaceMill> faceMills, RanhuraPerfilCircularParcial ranhuraTmp,
...
//					"    Feature: Ranhura Perfil Circular Parcial \n" +
...
//					"Erro", JOptionPane.ERROR_MESSAGE);
	...
	private BallEndMill chooseBallEndMill(Material material,
			ArrayList<BallEndMill> ballEndMills, RanhuraPerfilCircularParcial ranhuraTmp) {
