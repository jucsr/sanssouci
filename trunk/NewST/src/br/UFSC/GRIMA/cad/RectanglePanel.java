...
public class RectanglePanel extends DesenhadorDeFaces implements MouseListener, MouseMotionListener
{
	...
	private CreateRectangularBoss janelaRectangle;

	public RectanglePanel(Projeto projeto, CreateRectangularBoss janelaRectangle)
	{
		super(projeto);
