/*
 * Created by JFormDesigner on Mon Apr 15 18:09:29 BRT 2013
 */
 ...
 * @author Brainrain
 */
public class EditTwistDrillFrame extends JDialog {
	public EditTwistDrillFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public EditTwistDrillFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
			...
			//======== contentPanel ========
			{
				...
				//======== tabbedPane1 ========
				{
					...
					//======== panel1 ========
					{
						...
						((GridBagLayout)panel1.getLayout()).columnWidths = new int[] {345, 0, 0};
						((GridBagLayout)panel1.getLayout()).rowHeights = new int[] {0, 340, 0};
						...
						panel1.add(panel12, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,
							new Insets(0, 0, 0, 5), 0, 0));
						...
						//======== panel3 ========
						{
							...
							//======== panel10 ========
							{
								...
								panel10.add(label17, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
									GridBagConstraints.CENTER, GridBagConstraints.BOTH,
									new Insets(0, 0, 5, 5), 0, 0));

								//---- label18 ----
								label18.setText("Drilling");
								panel10.add(label18, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
									GridBagConstraints.CENTER, GridBagConstraints.BOTH,
									new Insets(0, 0, 5, 0), 0, 0));

								//---- label1 ----
								label1.setText("Id:");
								panel10.add(label1, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
									GridBagConstraints.CENTER, GridBagConstraints.BOTH,
									new Insets(0, 0, 5, 5), 0, 0));
								...
								panel10.add(label2, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
									GridBagConstraints.CENTER, GridBagConstraints.BOTH,
									new Insets(0, 0, 0, 5), 0, 0));
								...
								panel10.add(checkBox1, new GridBagConstraints(1, 2, 1, 1, 0.0, 0.0,
									GridBagConstraints.CENTER, GridBagConstraints.BOTH,
									new Insets(0, 0, 0, 0), 0, 0));
							}
							panel3.add(panel10, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 0), 0, 0));
						}
						...
						//======== panel5 ========
						{
							...
							//======== panel6 ========
							{
								...
								//======== layeredPane1 ========
								{
									...
									spinner5.setBounds(295, 55, 45, spinner5.getPreferredSize().height);
									...
									//---- label6 ----
									label6.setIcon(new ImageIcon(getClass().getResource("/images/twistDrill.png")));
					...
					//======== panel11 ========
					{
						...
						//======== layeredPane3 ========
						{
							...
							spinner13.setBounds(280, 125, 50, spinner13.getPreferredSize().height);

							//---- label23 ----
							label23.setText("m/min");
							layeredPane3.add(label23, JLayeredPane.DEFAULT_LAYER);
							label23.setBounds(335, 130, 50, label23.getPreferredSize().height);

							//---- spinner14 ----
							spinner14.setModel(new SpinnerNumberModel(0.0, 0.0, null, 1.0));
							layeredPane3.add(spinner14, JLayeredPane.DEFAULT_LAYER);
							spinner14.setBounds(270, 75, 50, spinner14.getPreferredSize().height);

							//---- label24 ----
							label24.setText("mm/rot");
							layeredPane3.add(label24, JLayeredPane.DEFAULT_LAYER);
							label24.setBounds(325, 80, 45, label24.getPreferredSize().height);

							//---- spinner15 ----
							spinner15.setModel(new SpinnerNumberModel(0, 0, null, 1));
							layeredPane3.add(spinner15, JLayeredPane.DEFAULT_LAYER);
							spinner15.setBounds(290, 10, 60, spinner15.getPreferredSize().height);

							//---- label25 ----
							label25.setText("rpm");
							layeredPane3.add(label25, JLayeredPane.DEFAULT_LAYER);
							label25.setBounds(355, 15, 35, label25.getPreferredSize().height);

							//---- label26 ----
							label26.setText("Cut Speed");
							layeredPane3.add(label26, JLayeredPane.DEFAULT_LAYER);
							label26.setBounds(190, 135, 70, label26.getPreferredSize().height);

							//---- label27 ----
							label27.setIcon(new ImageIcon(getClass().getResource("/images/technologyTwistDrill.png")));
					...
					tabbedPane1.addTab("Technology", panel11);
					...
					//======== panel13 ========
					{
						...
						//======== panel14 ========
						{
							...
							((GridBagLayout)panel14.getLayout()).columnWidths = new int[] {0, 0, 55, 0, 0};
							((GridBagLayout)panel14.getLayout()).rowHeights = new int[] {0, 0, 0, 0};
							((GridBagLayout)panel14.getLayout()).columnWeights = new double[] {1.0, 0.0, 0.0, 1.0, 1.0E-4};
							((GridBagLayout)panel14.getLayout()).rowWeights = new double[] {0.0, 0.0, 0.0, 1.0E-4};

							//---- label12 ----
							label12.setText("Cost");
							panel14.add(label12, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
							panel14.add(spinner12, new GridBagConstraints(2, 0, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));

							//---- label13 ----
							label13.setText("Time");
							panel14.add(label13, new GridBagConstraints(1, 1, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
							panel14.add(spinner16, new GridBagConstraints(2, 1, 1, 1, 0.0, 0.0,
								GridBagConstraints.CENTER, GridBagConstraints.BOTH,
								new Insets(0, 0, 5, 5), 0, 0));
						}
					...
					tabbedPane1.addTab("Cost and Time", panel13);
