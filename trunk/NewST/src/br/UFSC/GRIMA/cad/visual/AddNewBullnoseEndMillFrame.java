/*
 * Created by JFormDesigner on Fri May 20 16:14:58 BRT 2011
 */
 ...
 * @author Victor
 */
public class AddNewBullnoseEndMillFrame extends JDialog {
	public AddNewBullnoseEndMillFrame(Frame owner) {
		super(owner);
		initComponents();
	}

	public AddNewBullnoseEndMillFrame(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== this ========
		setTitle("Add new Bullnose End Mill");
				...
				//======== panel2 ========
				{
					...
					//======== panel1 ========
					{
						...
						//======== layeredPane1 ========
						{
							...
							spinner2.setBounds(205, 210, 36, spinner2.getPreferredSize().height);

							//---- spinner3 ----
							spinner3.setModel(new SpinnerNumberModel(40.0, 0.0, null, 1.0));
							layeredPane1.add(spinner3, JLayeredPane.DEFAULT_LAYER);
							spinner3.setBounds(90, 245, 35, spinner3.getPreferredSize().height);
							...
							spinner5.setBounds(143, -2, 36, 21);

							//---- spinner6 ----
							spinner6.setModel(new SpinnerNumberModel(20.0, 0.0, null, 1.0));
							layeredPane1.add(spinner6, JLayeredPane.DEFAULT_LAYER);
							spinner6.setBounds(140, 160, 36, spinner6.getPreferredSize().height);

							//---- spinner7 ----
							spinner7.setModel(new SpinnerNumberModel(2.0, 0.0, null, 1.0));
							layeredPane1.add(spinner7, JLayeredPane.DEFAULT_LAYER);
							spinner7.setBounds(195, 300, 35, spinner7.getPreferredSize().height);

							//---- label1 ----
							label1.setIcon(new ImageIcon(getClass().getResource("/images/bullnoseEndMill.png")));
							layeredPane1.add(label1, JLayeredPane.DEFAULT_LAYER);
							label1.setBounds(0, -5, label1.getPreferredSize().width, 344);
						}
